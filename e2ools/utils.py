...
def plot_debug_plots(interactions, true_probs, means, upper_limits, lower_limits, change_times,
    ...
    with matplotlib.backends.backend_pdf.PdfPages(save_dir) as pdf:
        for p in range(num_pages):
            ...
            for k in range(10):
                ...
                ax[i, j].plot(*true_probs[r], color='k', linewidth=2, alpha=0.5)
                ...
                ax[i, j].plot(x, y, color=posterior_color, linewidth=1.5, linestyle='--')
